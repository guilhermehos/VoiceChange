//
//  CidadeVCTableViewController.swift
//  ListaDeCidades
//
...
class CidadeVCTableViewController: UITableViewController {
    
    @IBOutlet weak var textTx: UITextField!
  
    @IBAction func adicionarCidade(_ sender: UIButton) {
        cidades.append(textTx.text!)
    ...
    override func viewDidLoad() {
        ...
        cidades.append("Sao Paulo")
        cidades.append("Limeira")
